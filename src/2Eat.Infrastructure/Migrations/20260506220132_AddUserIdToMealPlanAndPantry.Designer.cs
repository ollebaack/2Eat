...
namespace _2Eat.Infrastructure.Migrations
{
    ...
    [Migration("20260506220132_AddUserIdToMealPlanAndPantry")]
    partial class AddUserIdToMealPlanAndPantry
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("_2Eat.Domain.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CookTime = 15,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 7, 0, 1, 31, 512, DateTimeKind.Unspecified).AddTicks(5988), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CategoryId = 2,
                            CookTime = 0,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 7, 0, 1, 31, 512, DateTimeKind.Unspecified).AddTicks(9144), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CategoryId = 3,
                            CookTime = 120,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 7, 0, 1, 31, 512, DateTimeKind.Unspecified).AddTicks(9150), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            CategoryId = 4,
                            CookTime = 30,
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 5, 7, 0, 1, 31, 512, DateTimeKind.Unspecified).AddTicks(9155), new TimeSpan(0, 2, 0, 0, 0)),
