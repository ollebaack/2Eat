  ...
  { path: '/register', element: <RegisterPage /> },
  {
    ...
    children: [{
      ...
      children: [
        ...
        { path: '/recept/nytt', element: <RecipeFormPage /> },
        { path: '/recept/:id', element: <RecipeDetailPage /> },
        { path: '/recept/:id/redigera', element: <RecipeFormPage /> },
        { path: '/ingredienser', element: <IngredientsPage /> },
